...
import dev.typicalfarmingmacro.macro.impl.ADFarmMacro;
import dev.typicalfarmingmacro.macro.impl.CocoaBeansMacro;
import dev.typicalfarmingmacro.macro.impl.SDSMushroomMacro;
import dev.typicalfarmingmacro.macro.impl.SShapeCropMacro;
import dev.typicalfarmingmacro.macro.impl.SShapeSugarCaneMacro;
import dev.typicalfarmingmacro.macro.impl.WSCropMacro;
import dev.typicalfarmingmacro.macro.impl.WSFarmMacro;
 ...
 * {@link dev.typicalfarmingmacro.TfmClient}.
 */
public final class FarmingMacroManager {
    ...
    public static void loadDirection() {
        if (cachedRowDirection == null) {
            try {
                java.nio.file.Path path = net.fabricmc.loader.api.FabricLoader.getInstance().getConfigDir().resolve("typicalfarmingmacro_last_direction.txt");
    ...
    /**
     * Instantiates a macro instance based on the current {@link TfmConfig#FARM_TYPE}.
     */
    public static AbstractMacro createMacroFromConfig() {
        String typeName = TfmConfig.FARM_TYPE.get();
