...
import dev.typicalfarmingmacro.mixin.AccessorEntity;
...
public class InventoryHudElement extends HudElement {
    ...
    @Override public float getX() { return TfmConfig.INVENTORY_HUD_X.get(); }
    @Override public float getY() { return TfmConfig.INVENTORY_HUD_Y.get(); }
    @Override public void setX(float x) { TfmConfig.INVENTORY_HUD_X.set((int) x); }
    @Override public void setY(float y) { TfmConfig.INVENTORY_HUD_Y.set((int) y); }
    ...
    @Override public boolean isVisible() {
        if (!TfmConfig.SHOW_INVENTORY_HUD.get()) return false;
    ...
    protected void renderElement(NVGRenderer nvg, boolean editMode) {
        boolean showArmor = TfmConfig.INVENTORY_HUD_SHOW_ARMOR.get();
        boolean showPlayerModel = TfmConfig.INVENTORY_HUD_SHOW_PLAYER_MODEL.get();
