 ...
 *
 * <p>Subclasses implement position/scale accessors (backed by {@code TfmConfig}),
...
public abstract class HudElement {
    ...
    /** Persist position / scale changes (typically calls {@code TfmConfig.save()}). */
     ...
     * outside the NVG frame, after {@link dev.typicalfarmingmacro.renderer.NanoVGManager#endFrame()}.
