...
public class HudRegistry {
    ...
    public static void register() {
        ...
        HudElementRegistry.addLast(Identifier.fromNamespaceAndPath("typicalfarmingmacro", "hud"), (guiGraphics, delta) -> {
            ...
            TfmRenderQueue.enqueue(() -> renderGameplayFrame(sw, sh, alpha, frameDelta));
        });
    }
    ...
    private static boolean canRenderInGameplay(Minecraft mc) {
        if (TfmConfig.HUD_ONLY_WHILE_MACRO_RUNNING.get() && !MacroStateManager.isMacroRunning()) {
            return false;
        }
        return !TfmConfig.GUI_ONLY_IN_GARDEN.get()
