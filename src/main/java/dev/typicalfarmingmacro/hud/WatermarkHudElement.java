...
public class WatermarkHudElement extends HudElement {
    ...
    private static final String NAME    = "Tfm";
    ...
    private static final String LOGO_ICON        = "/assets/typicalfarmingmacro/icons/logo.svg";
    private static final String PERSON_ICON      = "/assets/typicalfarmingmacro/icons/person.svg";
    private static final String PERFORMANCE_ICON = "/assets/typicalfarmingmacro/icons/performance.svg";
    private static final String SIGNAL_ICON      = "/assets/typicalfarmingmacro/icons/signal.svg";
    private static final String CLOCK_ICON       = "/assets/typicalfarmingmacro/icons/clock.svg";
    private static final String REFRESH_ICON     = "/assets/typicalfarmingmacro/icons/refresh.svg";
    private static final String CASH_ICON        = "/assets/typicalfarmingmacro/icons/cash.svg";
    private static final String CALENDAR_ICON    = "/assets/typicalfarmingmacro/icons/calendar.svg";
    ...
    @Override public float   getX()            { return TfmConfig.WATERMARK_HUD_X.get(); }
    @Override public float   getY()            { return TfmConfig.WATERMARK_HUD_Y.get(); }
    @Override public void    setX(float x)     { TfmConfig.WATERMARK_HUD_X.set((int) x); }
    @Override public void    setY(float y)     { TfmConfig.WATERMARK_HUD_Y.set((int) y); }
    @Override public float   getScale()        { return TfmConfig.WATERMARK_HUD_SCALE.get(); }
    @Override public void    setScale(float s) { TfmConfig.WATERMARK_HUD_SCALE.set(s); }
    @Override public float   getWidth()        { return PAD_H * 2f + 200f; }
    @Override public float   getHeight()       { return PAD_V * 2f + NAME_SZ; }
    @Override public boolean isVisible()       { return (TfmConfig.HUD_THEME.get() & 0x2) != 0; }
    ...
    protected void renderElement(NVGRenderer nvg, boolean editMode) {
        ...
        boolean showLogo  = TfmConfig.WATERMARK_SHOW_LOGO.get();
        boolean showName  = TfmConfig.WATERMARK_SHOW_NAME.get();
        boolean gradient  = TfmConfig.WATERMARK_GRADIENT.get();
        int     gradLeft  = gradient ? TfmConfig.WATERMARK_GRADIENT_LEFT.get()  : Theme.ACCENT_PRIMARY;
        int     gradRight = gradient ? TfmConfig.WATERMARK_GRADIENT_COLOR.get() : Theme.ACCENT_PRIMARY;

        boolean wantMacro = TfmConfig.WATERMARK_SHOW_MACRO_STATUS.get() && MacroStateManager.isMacroRunning();
        ...
        // ---- Normal info data -----------------------------------------------
        boolean showUser = TfmConfig.WATERMARK_SHOW_USERNAME.get();
        boolean showFps  = TfmConfig.WATERMARK_SHOW_FPS.get();
        boolean showPing = TfmConfig.WATERMARK_SHOW_PING.get();
        boolean showTime = TfmConfig.WATERMARK_SHOW_TIME.get();
        String custom    = TfmConfig.WATERMARK_CUSTOM_USERNAME.get();
