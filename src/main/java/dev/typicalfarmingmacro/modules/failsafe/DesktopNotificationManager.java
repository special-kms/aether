...
public final class DesktopNotificationManager {
    ...
    private static final String APP_NAME = "Typical Farming Macro";
    private static final ExecutorService EXECUTOR = Executors.newSingleThreadExecutor(r -> {
        Thread thread = new Thread(r, "Tfm-DesktopNotification");
    ...
    private static void dispatch(String title, String body, boolean critical) {
        try {
            ...
            System.err.println("[Tfm] Failed to send desktop notification: " + e.getMessage());
        }
    }
    ...
    private static List<String> buildCommand(String title, String body, boolean critical) {
        ...
        if (notifySend == null) {
            System.err.println("[Tfm] Desktop notifications need 'notify-send' (libnotify) and a "
