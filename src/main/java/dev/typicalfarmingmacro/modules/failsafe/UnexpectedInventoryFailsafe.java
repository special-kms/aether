...
final class UnexpectedInventoryFailsafe {
    ...
    static void tick(Minecraft client) {
        ...
        long triggerDelayMs = Math.round(TfmConfig.FAILSAFE_UNEXPECTED_INVENTORY_GUI_DELAY_SECONDS.get() * 1000.0f)
    ...
    static State getState(Minecraft client) {
        ...
        if (client == null || client.player == null || !TfmConfig.FAILSAFE_UNEXPECTED_INVENTORY_GUI.get()) {
            return State.IDLE;
        }
