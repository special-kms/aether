...
public class RestartManager {
        ...
        if (MacroStateManager.getCurrentState() != MacroState.State.OFF
            ...
            if (contestMs > 0) {
                dev.typicalfarmingmacro.util.ClientUtils.sendMessage(client,
                        "\u00A7c" + String.format(
                                dev.typicalfarmingmacro.util.TfmLang.localize(
    ...
    public static void update(Minecraft client) {
        ...
        if (restartSequenceStage == 0 && System.currentTimeMillis() >= restartExecutionTime) {
            ...
            dev.typicalfarmingmacro.util.ClientUtils.sendMessage(client, "\u00A7cExecuting delayed restart abort sequence...", false);
            ...
            boolean spawnConfirmed = dev.typicalfarmingmacro.util.CommandUtils.hasSpawnBeenSet(restartSetSpawnWindow);
