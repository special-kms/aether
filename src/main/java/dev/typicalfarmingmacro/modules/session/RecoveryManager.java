...
public class RecoveryManager {
    ...
    public static void beginWorldChangeRecovery(Vec3 savedPosition) {
        ...
        worldChangeWaitUntilMs = System.currentTimeMillis()
                + Math.round(TfmConfig.FAILSAFE_WORLD_CHANGE_RECOVERY_WAIT_SECONDS.get() * 1000.0f);
        worldChangeUsedWalkAssist = false;
        worldChangeAlignClicked = false;
    }
    ...
    public static void update(Minecraft client) {
        ...
        if (recoveryFailedAttempts >= 15) {
            dev.typicalfarmingmacro.util.ClientUtils.sendMessage(client, "\u00A7cAuto-recovery failed after 15 attempts. Stopping farming.", false);
        ...
        switch (currentLoc) {
            case LIMBO:
                ...
                dev.typicalfarmingmacro.util.ClientUtils.sendMessage(client, "\u00A7eRecovery (attempt "
            ...
            case UNKNOWN:
                ...
                break;
            case GARDEN:
                dev.typicalfarmingmacro.util.ClientUtils.sendMessage(client, "\u00A7aRecovery successful. Resuming farming...", false);
                recoveryFailedAttempts = 0;
                recoveryMode = RecoveryMode.STANDARD;
                dev.typicalfarmingmacro.modules.session.DynamicRestManager.scheduleNextRest();
