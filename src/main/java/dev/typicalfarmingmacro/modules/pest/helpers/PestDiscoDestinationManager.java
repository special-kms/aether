...
public final class PestDiscoDestinationManager {
    ...
    public static boolean isEnabled() {
        return TfmConfig.PEST_DISCO_DESTINATION_MODE.get();
    }

    public static boolean isConfigured() {
        return isEnabled()
                && isUsablePlot(TfmConfig.PEST_DISCO_DESTINATION_PLOT.get());
    }

    public static String getConfiguredPlot() {
        return normalizePlot(TfmConfig.PEST_DISCO_DESTINATION_PLOT.get());
    }
