...
public final class TfmProxy {
    ...
    public TfmProxy(String name, String address, ProxyType type, String username, String password) {
    ...
    public String displayName() {
        String label = name();
        return label.isBlank() ? TfmLang.localize("Unnamed Proxy") : label;
    }

    public String shortStatus() {
        if (!isValid()) {
            return TfmLang.localize("invalid");
        }
        return type().displayName() + " " + address();
    }

    public TfmProxy copy() {
        return new TfmProxy(name(), address(), type(), username(), password());
    }
    ...
    public enum ProxyType {
        ...
        public String displayName() {
            return TfmLang.localize(displayName);
        }
