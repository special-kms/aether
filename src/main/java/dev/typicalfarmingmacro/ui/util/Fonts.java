package dev.typicalfarmingmacro.ui.util;

/**
 * Font name constants for use with {@link dev.typicalfarmingmacro.renderer.NVGRenderer}.
 *
 * <p>These names correspond to fonts loaded by {@link dev.typicalfarmingmacro.renderer.NanoVGManager}
