...
final class MainGUIRenderPrimitives {
    ...
    void renderModuleCard(NVGRenderer nvg, ModulesTab.SubTab subTab, float x, float y, float w, float hover, float mx, float my) {
        ...
        List<String> nameLines = textLayout.wrapTextToWidth(nvg, TfmLang.localize(subTab.name()), Fonts.BOLD, 13f, textMaxW);
        List<String> descriptionLines = textLayout.wrapTextToWidth(nvg, TfmLang.localize(subTab.description()), Fonts.REGULAR, 10f, textMaxW);
