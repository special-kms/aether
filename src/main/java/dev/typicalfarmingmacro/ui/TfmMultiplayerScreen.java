 ...
 * via {@link dev.typicalfarmingmacro.mixin.MixinJoinMultiplayerScreen}.
 */
public class TfmMultiplayerScreen extends Screen {
    ...
    public TfmMultiplayerScreen(Screen lastScreen) {
        super(Component.literal(TfmLang.localize("Multiplayer")));
    ...
    public void extractBackground(GuiGraphicsExtractor g, int mx, int my, float delta) {
        // Suppressed - TfmBackground handles it.
    }
    ...
    private void drawProxyButton(NVGRenderer nvg) {
        ...
        nvg.textCentered(Fonts.REGULAR, TfmProxyManager.selectedStatus(), proxyX, proxyY, PROXY_W, PROXY_H, 12f,
    ...
    public boolean mouseClicked(MouseButtonEvent click, boolean doubled) {
        ...
        if (mx >= proxyX && mx <= proxyX + PROXY_W && my >= proxyY && my <= proxyY + PROXY_H) {
            minecraft.setScreen(new TfmProxyScreen(this));
            return true;
        }
