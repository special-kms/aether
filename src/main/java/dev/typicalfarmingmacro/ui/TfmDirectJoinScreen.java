 ...
 * via {@link dev.typicalfarmingmacro.mixin.MixinDirectJoinServerScreen}.
 */
public class TfmDirectJoinScreen extends Screen {
    ...
    public TfmDirectJoinScreen(Screen lastScreen, BooleanConsumer callback, ServerData serverData) {
