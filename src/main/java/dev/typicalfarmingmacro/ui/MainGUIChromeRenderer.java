...
final class MainGUIChromeRenderer {
    ...
    void renderSidebar(NVGRenderer nvg, float mx, float my) {
        ...
        if (context.animation.computedSidebarExpanded < 1f) {
            float maxTW = 0f;
            for (String name : new String[]{TfmLang.localize("Modules"), TfmLang.localize("Colors"), TfmLang.localize("Config"), TfmLang.localize("Keybinds"), TfmLang.localize("Settings"), TfmLang.localize("HUD Positions")}) {
        ...
        nvg.renderSVG("/assets/typicalfarmingmacro/icons/logo.svg", logoX, logoY, logoSize, logoSize, Theme.ACCENT_PRIMARY);
        if (context.animation.sidebarAnim > 0.01f) {
            ...
            nvg.text(Fonts.BOLD, TfmLang.localize("Tfm"), textX, logoY + (logoSize - 14f) / 2f, 18f, Theme.ACCENT_PRIMARY);
            nvg.restore();
        }
        ...
        String[] tabLabels = { TfmLang.localize("Modules"), TfmLang.localize("Colors"), TfmLang.localize("Config") };
        ...
        for (int i = 0; i < tabLabels.length; i++) {
            ...
            nvg.renderSVG("/assets/typicalfarmingmacro/icons/" + tabIds[i] + ".svg",
        ...
        nvg.renderSVG("/assets/typicalfarmingmacro/icons/hud_positions.svg",
        ...
        if (context.animation.sidebarAnim > 0.01f) {
            ...
            nvg.globalAlpha(context.animation.sidebarAnim);
            nvg.translate((1f - context.animation.sidebarAnim) * -6f, 0f);
            nvg.text(Fonts.REGULAR, TfmLang.localize("HUD Positions"), textX, hudPillY + (MainGUI.SB_PILL - 12f) / 2f, 12f, hudColor);
            nvg.restore();
        }
        ...
        nvg.renderSVG("/assets/typicalfarmingmacro/icons/keybinds.svg",
        ...
        if (context.animation.sidebarAnim > 0.01f) {
            ...
            nvg.globalAlpha(context.animation.sidebarAnim);
            nvg.translate((1f - context.animation.sidebarAnim) * -6f, 0f);
            nvg.text(Fonts.REGULAR, TfmLang.localize("Keybinds"), textX, keybindsPillY + (MainGUI.SB_PILL - 12f) / 2f, 12f, keybindsColor);
            nvg.restore();
        }
        ...
        nvg.renderSVG("/assets/typicalfarmingmacro/icons/settings.svg",
        ...
        if (context.animation.sidebarAnim > 0.01f) {
            ...
            nvg.globalAlpha(context.animation.sidebarAnim);
            nvg.translate((1f - context.animation.sidebarAnim) * -6f, 0f);
            nvg.text(Fonts.REGULAR, TfmLang.localize("Settings"), textX, settingsPillY + (MainGUI.SB_PILL - 12f) / 2f, 12f, settingsColor);
            nvg.restore();
        }
    ...
    void renderContentTopBar(NVGRenderer nvg, float mx, float my) {
        ...
        nvg.renderSVG("/assets/typicalfarmingmacro/icons/search.svg",
        ...
        if (context.navigation.searchQuery.isEmpty()) {
            nvg.text(Fonts.REGULAR, TfmLang.localize("Search settings..."),
