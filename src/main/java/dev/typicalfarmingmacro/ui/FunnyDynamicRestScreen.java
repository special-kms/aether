...
public class FunnyDynamicRestScreen extends DisconnectedScreen {
    ...
    public FunnyDynamicRestScreen(long restEndTimeMs) {
        super(
                ...
                Component.literal(TfmLang.localize("Failed to connect to the server")),
                buildReason(restEndTimeMs),
                Component.literal(TfmLang.localize("Back to Server List")));
    ...
    private static Component buildReason(long restEndTimeMs) {
        return Component.empty()
                .append(Component.literal(TfmLang.localize("You are temporarily banned for ")).withStyle(ChatFormatting.RED))
                .append(Component.literal(formatRemainingDuration(restEndTimeMs)).withStyle(ChatFormatting.WHITE))
                .append(Component.literal(TfmLang.localize(" from this server!")).withStyle(ChatFormatting.RED))
                .append("\n\n")
                .append(Component.literal(TfmLang.localize("Reason: ")).withStyle(ChatFormatting.GRAY))
                .append(Component.literal(TfmLang.localize("Cheating through the use of unfair game advantages.")).withStyle(ChatFormatting.WHITE))
                .append("\n")
                .append(Component.literal(TfmLang.localize("Find out more: ")).withStyle(ChatFormatting.GRAY))
                .append(Component.literal(TfmLang.localize("https://www.hypixel.net/appeal"))
                        .withStyle(ChatFormatting.AQUA, ChatFormatting.UNDERLINE))
                .append("\n\n")
                .append(Component.literal(TfmLang.localize("Ban ID: ")).withStyle(ChatFormatting.GRAY))
                .append(Component.literal(TfmLang.localize("#TFMSB")).withStyle(ChatFormatting.WHITE))
                .append("\n")
                .append(Component.literal(TfmLang.localize("Sharing your Ban ID may affect the processing of your appeal!"))
