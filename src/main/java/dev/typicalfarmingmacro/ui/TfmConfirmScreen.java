 ...
 * via {@link dev.typicalfarmingmacro.mixin.MixinConfirmScreen}.
 */
public class TfmConfirmScreen extends Screen {
    ...
    public TfmConfirmScreen(BooleanConsumer callback, Component title, Component message) {
        super(title);
    ...
    public void extractRenderState(GuiGraphicsExtractor g, int mx, int my, float partialTick) {
        ...
        TfmRenderQueue.enqueue(() -> renderQueued(mx, my, enabled));
    }
