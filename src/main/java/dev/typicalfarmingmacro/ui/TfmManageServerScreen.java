...
import dev.typicalfarmingmacro.ui.util.TextInput;
 ...
 * via {@link dev.typicalfarmingmacro.mixin.MixinManageServerScreen}.
 */
public class TfmManageServerScreen extends Screen {
    ...
    public TfmManageServerScreen(Screen lastScreen, Component title,
    ...
    public void extractRenderState(GuiGraphicsExtractor g, int mx, int my, float partialTick) {
        ...
        TfmRenderQueue.enqueue(() -> renderQueued(mx, my));
    }
    ...
    private void drawUI(NVGRenderer nvg) {
        ...
        // Server Name
        nvg.text(Fonts.REGULAR, TfmLang.localize("Server Name"), fx, nameLabelY, 10f, Theme.withAlpha(0xFFFFFFFF, 0x80));
        ...
        // Server IP
        nvg.text(Fonts.REGULAR, TfmLang.localize("Server IP"), fx, ipLabelY, 10f, Theme.withAlpha(0xFFFFFFFF, 0x80));
        ...
        // Buttons
        drawBtn(nvg, TfmLang.localize("Done"),   leftBtnX,  hov[0], accent);
        drawBtn(nvg, TfmLang.localize("Cancel"), rightBtnX, hov[1], accent);
    }
