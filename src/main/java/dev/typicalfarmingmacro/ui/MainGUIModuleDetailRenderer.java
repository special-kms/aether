...
final class MainGUIModuleDetailRenderer {
    ...
    void renderTopBar(NVGRenderer nvg, float mx, float my) {
        ...
        String backLabel = "\u2190 " + TfmLang.localize("Back");
        ...
        nvg.text(Fonts.REGULAR, TfmLang.localize("Module settings"), sep2X + 12f, descY, 12f, Theme.TEXT_MUTED);
    ...
    void renderCategoryPanel(NVGRenderer nvg, float mx, float my, float panelTop, float panelH) {
        ...
        nvg.text(Fonts.BOLD, TfmLang.localize("Categories").toUpperCase(), categoryX + 16f, panelTop + 18f, 9f,
        ...
        for (int i = 0; i < totalItems; i++) {
            ...
            String label = isAll ? TfmLang.localize("All") : TfmLang.localize(groups.get(groupIndex).getName());
    ...
    void renderSettingsPanel(NVGRenderer nvg, float mx, float my, float panelTop, float panelH) {
        ...
        String moduleDescription = TfmLang.localize(activeSubTab.description());
