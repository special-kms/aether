...
import dev.typicalfarmingmacro.ui.components.Component;
...
public abstract class NVGScreen extends Screen {
    ...
    protected NVGScreen(String title) {
        super(net.minecraft.network.chat.Component.literal(TfmLang.localize(title)));
    }
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
        TfmRenderQueue.enqueue(this::renderQueued);
    }
