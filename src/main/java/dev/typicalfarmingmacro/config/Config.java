...
import dev.typicalfarmingmacro.config.entries.*;
...
public final class Config {
    ...
    public static boolean loadFrom(Path path) {
        ...
        try {
            ...
            System.err.println("[Tfm] Config load failed for " + path + ": " + e.getMessage());
            return false;
        }
    }
    ...
    public static boolean loadFromJson(String json) {
        ...
        try {
            ...
            System.err.println("[Tfm] Config import failed: " + e.getMessage());
            return false;
        }
    }
    ...
    public static void load() {
        ...
        try {
            ...
            System.err.println("[Tfm] Corrupt config file found. Wiping config and starting fresh: " + e.getMessage());
            withoutAutosave(Config::resetEntriesOnly);
            dirty = true;
            try {
