...
public final class ConfigManager {
    ...
    public static void init() {
        configPath = FabricLoader.getInstance().getConfigDir().resolve("typicalfarmingmacro_ui.json");
        registerDefaults();
        load();
    }
    ...
    public static void load() {
        ...
        try (Reader r = Files.newBufferedReader(configPath)) {
            ...
            System.err.println("[typicalfarmingmacro] Config load failed: " + ex.getMessage());
        }
    }
    ...
    public static void save() {
        ...
        catch (Exception ex) { System.err.println("[typicalfarmingmacro] Config save failed: " + ex.getMessage()); }
    }
