 ...
 * {@code config/typicalfarmingmacro/profiles/}.
 *
...
public final class ConfigProfileManager {
    ...
    private static final Path DIR = FabricLoader.getInstance().getConfigDir()
            .resolve("typicalfarmingmacro").resolve("profiles");
    ...
    public static void save(String name) {
        ...
        try {
            Files.writeString(profilePath, TfmConfig.toJsonString());
    ...
    public static boolean load(String name) {
        ...
        boolean loaded = TfmConfig.loadFrom(src.toFile());
        if (loaded) {
            activeProfilePath = src;
            TfmBootstrapHooks.onConfigProfileLoaded(src.toFile());
            TfmConfig.flush();
