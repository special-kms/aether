...
public final class RewarpPointPairs {
    ...
    public static List<RewarpPointPair> get() {
        List<String> entries = TfmConfig.REWARP_POINT_PAIRS.get();
    ...
    private static boolean shouldUseLegacyEntry(List<String> entries) {
        ...
        return hasNonZeroLegacyCoordinate(TfmConfig.REWARP_START_X.get(), TfmConfig.REWARP_START_Y.get(), TfmConfig.REWARP_START_Z.get())
                || hasNonZeroLegacyCoordinate(TfmConfig.REWARP_END_X.get(), TfmConfig.REWARP_END_Y.get(), TfmConfig.REWARP_END_Z.get());
    }
    ...
    public static void update(int index, Consumer<RewarpPointPair> updater) {
        List<String> entries = new ArrayList<>(TfmConfig.REWARP_POINT_PAIRS.get());
        ...
        TfmConfig.REWARP_POINT_PAIRS.set(entries);
        TfmConfig.save();
    }
